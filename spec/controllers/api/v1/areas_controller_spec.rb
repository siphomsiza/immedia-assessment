...
RSpec.describe Api::V1::AreasController, type: :controller do
  ...
  # Api::V1::Area. As you add validations to Api::V1::Area, be sure to
  ...
  # Api::V1::AreasController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all api_v1_areas as @api_v1_areas" do
      area = Api::V1::Area.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:api_v1_areas)).to eq([area])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested api_v1 as @api_v1" do
      ...
      expect(assigns(:api_v1)).to eq(area)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new api_v1 as @api_v1" do
      ...
      expect(assigns(:api_v1)).to be_a_new(Api::V1::Area)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested api_v1" do
        area = Api::V1::Area.create! valid_attributes
        put :update, {:id => area.to_param, :api_v1 => new_attributes}, valid_session
        area.reload
      ...
      it "assigns the requested api_v1 as @api_v1" do
        area = Api::V1::Area.create! valid_attributes
        put :update, {:id => area.to_param, :api_v1 => valid_attributes}, valid_session
        expect(assigns(:api_v1)).to eq(area)
      end
    ...
    context "with invalid params" do
      it "assigns the api_v1 as @api_v1" do
        area = Api::V1::Area.create! valid_attributes
        put :update, {:id => area.to_param, :api_v1 => invalid_attributes}, valid_session
        expect(assigns(:api_v1)).to eq(area)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the api_v1_areas list" do
      area = Api::V1::Area.create! valid_attributes
      delete :destroy, {:id => area.to_param}, valid_session
      expect(response).to redirect_to(api_v1_areas_url)
    end
  end
