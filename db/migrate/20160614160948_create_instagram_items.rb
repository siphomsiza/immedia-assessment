class CreateInstagramItems < ActiveRecord::Migration
  def change
    create_table :instagram_items , id: :uuid, default: "uuid_generate_v4()" do |t|
    ...
    add_foreign_key :instagram_items, :users, on_delete: :cascade, on_update: :cascade, column: :user_id
  end
end
